...
import 'package:plantist_app_/Screen/ToDoFlow/AddToDoFlow/AddToDoDetailBottomSheet/add_todo_details_view.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.todo != null) {
        ...
        viewModel.attachmentUrl.value = widget.todo!.attachment;
        viewModel.todoId = widget.todo!.id;
      }
    });
  }
